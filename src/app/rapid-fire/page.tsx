      ...
      <main className="flex-1 flex flex-col container mx-auto max-w-3xl px-4 pb-4">
        {isWaiting ? (
          <div className="flex-1 flex flex-col items-center justify-center">
            <div className="bg-card border rounded-lg p-6 w-full max-w-md mx-auto shadow-lg space-y-6 text-center">
            ...
            <div className="bg-card border rounded-lg p-6 w-full max-w-xl mx-auto shadow-lg">
                ...
                <TabsContent value="create" className="space-y-6">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Make your topic specific and debatable. Good topics have strong opinions on both sides.
                    </p>
                  </div>
                ...
                <TabsContent value="join" className="space-y-6">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-3">
                      Each topic below has exactly 1 person waiting. Join to start the debate immediately.
                    </p>
                      ...
                      {activeTopics.map(topic => (
                        ...
                        >
                          <div className="flex justify-between">
                            ...
                            <span className="text-xs bg-orange-100 dark:bg-orange-900/20 text-orange-800 dark:text-orange-300 px-2 py-0.5 rounded-full">
                              {topic.category}
                            </span>
                          </div>
              ...
              <div className="mt-6 pt-6 border-t">
                ...
                <p className="text-center text-xs text-muted-foreground mt-1">
                  When you create a topic, you'll wait for one other person to join. When you join a topic, the debate starts immediately.
                </p>
              </div>
            </div>
          </div>
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto py-2 space-y-4">
              ...
              {timeLeft === 0 && (
                <div className="bg-orange-100 dark:bg-orange-900/20 border border-orange-300 dark:border-orange-800 p-4 rounded-lg text-center">
